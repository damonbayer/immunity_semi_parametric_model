...
dat <- read_csv_as_draws("data/simulation/compare_inference_known_variant_proportion_2/simulated_data.csv") %>% tidy_predictive()

gq <- read_csv_as_draws("data/simulation/compare_inference_known_variant_proportion_2/true_generated_quantities.csv") %>% tidy_generated_quantities()
