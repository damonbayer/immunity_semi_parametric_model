...
results_dir(args...) = projectdir("results", "simulation", "compare_inference_known_variant_proportion_2", "SEIRS_variant", args...)
mkpath(results_dir())

sim_id = 1
include(simulationdir("load_simulated_data.jl"))

include(simulationdir("SEIRS_variant", "prior_constants_SEIRS_variant_model.jl"))
