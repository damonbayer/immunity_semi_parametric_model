...
dat <- read_csv_as_draws("data/simulation/compare_inference_unknown_variant_proportion_ihr_hifi/simulated_data.csv") %>%
  tidy_predictive() %>% 
...
gq <- read_csv_as_draws("data/simulation/compare_inference_unknown_variant_proportion_ihr_hifi/true_generated_quantities.csv") %>%
