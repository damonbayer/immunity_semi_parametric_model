...
results_dir(args...) = projectdir("results", "simulation", "compare_inference_unknown_variant_proportion_ihr_hifi", "SEIRS_ihr_gmrf_R0_gmrf_immunity_constant", args...)
mkpath(results_dir())

include(simulationdir("shared_constants.txt"))
include(simulationdir("load_simulated_data.jl"))
include(simulationdir("SEIRS_ihr_gmrf_R0_gmrf_immunity_constant", "prior_constants.jl"))
