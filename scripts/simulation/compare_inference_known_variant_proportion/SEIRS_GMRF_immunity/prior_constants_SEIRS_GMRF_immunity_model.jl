...
const σ_dur_waning_non_centered_loc = -2
const σ_dur_waning_non_centered_scale = 0.1

const dur_waning_init_non_centered_loc = log(20)
const dur_waning_init_non_centered_scale = 0.05