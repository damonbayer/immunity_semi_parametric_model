...
dat <- read_csv_as_draws("data/simulation/compare_inference_unknown_variant_proportion_ihr_contact/simulated_data.csv") %>% tidy_predictive()

gq <- read_csv_as_draws("data/simulation/compare_inference_unknown_variant_proportion_ihr_contact/true_generated_quantities.csv") %>% tidy_generated_quantities()
