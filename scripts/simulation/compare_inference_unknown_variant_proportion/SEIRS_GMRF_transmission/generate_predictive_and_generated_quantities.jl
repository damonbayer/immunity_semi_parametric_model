...
results_dir(args...) = projectdir("results", "simulation", "compare_inference_unknown_variant_proportion", "SEIRS_GMRF_transmission", args...)
mkpath(results_dir())
...
model_generated_quantities = seirs_gmrf_transmission(prob, data_new_cases_forecast, data_new_deaths_forecast, data_hospitalizations_forecast, data_icu_forecast, obstimes_forecast, param_change_times_forecast, Tsit5(), 1e-13, 1e-10)
model_predict = seirs_gmrf_transmission(prob, missing_data_new_cases_forecast, missing_data_new_deaths_forecast, missing_data_hospitalizations_forecast, missing_data_icu_forecast, obstimes_forecast, param_change_times_forecast, Tsit5(), 1e-13, 1e-10)
