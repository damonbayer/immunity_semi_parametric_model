...
results_dir(args...) = projectdir("results", "simulation", "compare_inference_unknown_variant_proportion", "SEIRS_unknown_variant", args...)
mkpath(results_dir())
...
model_optimization = seirs_unknown_prop_variant_2(prob, 20, data_new_cases, data_new_deaths, data_hospitalizations, data_icu, data_new_seq_variant_1, data_new_seq_variant_2, obstimes, param_change_times, Tsit5(), 1e-13, 1e-10)
model_generated_quantities = seirs_unknown_prop_variant_2(prob, 20, data_new_cases_forecast, data_new_deaths_forecast, data_hospitalizations_forecast, data_icu_forecast, data_new_seq_variant_1_forecast, data_new_seq_variant_2_forecast, obstimes_forecast, param_change_times_forecast, Tsit5(), 1e-13, 1e-10)
model_predict = seirs_unknown_prop_variant_2(prob, 20, missing_data_new_cases_forecast, missing_data_new_deaths_forecast, missing_data_hospitalizations_forecast, missing_data_icu_forecast, missing_data_new_seq_variant_1_forecast, missing_data_new_seq_variant_2_forecast, obstimes_forecast, param_change_times_forecast, Tsit5(), 1e-13, 1e-10)
