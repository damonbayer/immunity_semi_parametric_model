...
elseif immunity_model == "seq-informed"
    const prop_variant_2_immunity_offset_non_centered_loc = 0
    const dur_saturated_immune_non_centered_loc = log(20)
    const prop_dur_mixed_immune_non_centered_loc = logit(0.25)
    const dur_immune_shape_1_non_centered_loc = log(1)
    const dur_immune_shape_2_non_centered_loc = log(1)
end
...
elseif immunity_model == "seq-informed"
    const prop_variant_2_immunity_offset_non_centered_scale = 1.0
    const dur_saturated_immune_non_centered_scale = 0.05
    const prop_dur_mixed_immune_non_centered_scale = 0.3
    const dur_immune_shape_1_non_centered_scale = 0.5
    const dur_immune_shape_2_non_centered_scale = 0.5
end
