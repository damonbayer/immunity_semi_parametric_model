...
results_dir(args...) = projectdir("results", "simulation", "compare_inference_unknown_variant_proportion_ihr_hifi_contact", "SEIRS_ihr_seq_R0_constant_immunity_seq", args...)
mkpath(results_dir())
