...
results_dir(args...) = projectdir("results", "simulation", "compare_inference_unknown_variant_proportion_ihr_hifi_contact", "SEIRS_ihr_gmrf_R0_gmrf_immunity_gmrf", args...)
mkpath(results_dir())
