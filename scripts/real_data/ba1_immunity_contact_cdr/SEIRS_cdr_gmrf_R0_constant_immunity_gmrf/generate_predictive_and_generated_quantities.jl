...
results_dir(args...) = projectdir("results", "real_data", "ba1_immunity_contact_cdr", "SEIRS_cdr_gmrf_R0_constant_immunity_gmrf", args...)
mkpath(results_dir())

include(datadir("shared_constants.txt"))
include(simulationdir("load_real_data.jl"))
include(simulationdir("SEIRS_cdr_gmrf_R0_constant_immunity_gmrf", "prior_constants.jl"))
