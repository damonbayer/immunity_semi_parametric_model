...
forecast_comparison_plots <-
  ...
  mutate(
    file_path = path(defense_figure_dir, glue("simulated_forecast_comparison_{target_type}_{target_data_takeover_speed}_plot"), ext = "pdf"),
...
crps_comparison_plots <-
  ...
  mutate(
    file_path = path(defense_figure_dir, glue("simulated_crps_comparison_{target_type}_plot"), ext = "pdf"),
...
crps_comparison_boxplot_plots <-
  tibble(target_type = all_target_types) %>%
  mutate(
    file_path = path(defense_figure_dir, glue("simulated_crps_comparison_boxplot_{target_type}_plot"), ext = "pdf"),
...
crps_comparison_dotplot_plots <-
  tibble(target_type = all_target_types) %>%
  mutate(
    file_path = path(defense_figure_dir, glue("simulated_crps_comparison_dotplot_{target_type}_plot"), ext = "pdf"),
...
peak_assessment_plots <-
  ...
  mutate(
    file_path = path(defense_figure_dir, glue("simulated_peak_assessment_{peak_type}_plot"), ext = "pdf"),
...
peak_crps_plots <-
  tibble(x = 1) %>%
  mutate(
    file_path = path(defense_figure_dir, glue("simulated_peak_crps_plot"), ext = "pdf"),
...
peak_crps_boxplot_plots <-
  tibble(x = 1) %>%
  mutate(
    file_path = path(defense_figure_dir, glue("simulated_peak_crps_boxplot_plot"), ext = "pdf"),
...
peak_crps_dotplot_plots <-
  tibble(x = 1) %>%
  mutate(
    file_path = path(defense_figure_dir, glue("simulated_peak_crps_dotplot_plot"), ext = "pdf"),
