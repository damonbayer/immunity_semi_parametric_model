...
@model function seirs_known_prop_variant_2(prob, prop_variant_2_fn, data_new_cases, data_new_deaths, data_hospitalizations, data_icu, obstimes, param_change_times, DEAlgorithm, abstol, reltol)
