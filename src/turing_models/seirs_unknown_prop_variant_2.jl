...
@model function seirs_unknown_prop_variant_2(prob, logistic_growth_time_offset, data_new_cases, data_new_deaths, data_hospitalizations, data_icu, data_new_seq_variant_1, data_new_seq_variant_2, obstimes, param_change_times, DEAlgorithm, abstol, reltol)
