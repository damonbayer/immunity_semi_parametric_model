...
@model function seirs_multivariant_sequencing_hifi(data_new_cases_variant_1, data_new_cases_variant_2, data_hospitalizations, data_icu, data_new_deaths, data_new_seq_variant_1, data_new_seq_variant_2, obstimes, prob, DEAlgorithm, abstol, reltol, variant_2_import_time, seq_obstimes, init_index_to_report=1)
    ...
    seq_sol = solve(prob, DEAlgorithm; callback=param_callback, saveat=vcat(seq_obstimes[1] - 1 / 7, seq_obstimes), save_start=false, verbose=false, abstol=abstol, reltol=reltol, u0=u0, p=p, tspan=(0.0, seq_obstimes[end]))
    # If the ODE solver fails, reject the sample by adding -Inf to the likelihood
    ...
    seq_sol_new_cases_variant_1 = vec(seq_sol_reg_scale_array[25, 2:end] - seq_sol_reg_scale_array[25, 1:(end-1)])
    seq_sol_new_cases_variant_2 = vec(sum(seq_sol_reg_scale_array[26:28, 2:end] - seq_sol_reg_scale_array[26:28, 1:(end-1)], dims=1))
    ...
    seq_I₁ = seq_sol_reg_scale_array[7, :]
    seq_I₁₂ = seq_sol_reg_scale_array[8, :]
    seq_I₂ = seq_sol_reg_scale_array[9, :]
    seq_I₂₂ = seq_sol_reg_scale_array[10, :]
    ...
    return (
        ...
        seq_prop_variant_2=((seq_I₁₂+seq_I₂+seq_I₂₂)./(seq_I₁+seq_I₁₂+seq_I₂+seq_I₂₂)),
