...
@model function seirs_super_model_flex(prob, logistic_growth_time_offset, data_new_cases, data_new_deaths, data_hospitalizations, data_icu, data_new_seq_variant_1, data_new_seq_variant_2,
    ...
    elseif immunity_model == "seq-informed"
        ...
        dur_immune_shape_1_non_centered ~ Normal()
        dur_immune_shape_2_non_centered ~ Normal()
    ...
    elseif immunity_model == "seq-informed"
        prop_variant_2_immunity_offset = prop_variant_2_immunity_offset_non_centered * prop_variant_2_immunity_offset_non_centered_scale + prop_variant_2_immunity_offset_non_centered_loc
        ...
        dur_immune_shape_1 = exp(dur_immune_shape_1_non_centered * dur_immune_shape_1_non_centered_scale + dur_immune_shape_1_non_centered_loc)
        dur_immune_shape_2 = exp(dur_immune_shape_2_non_centered * dur_immune_shape_2_non_centered_scale + dur_immune_shape_2_non_centered_loc)

        dur_immune_α₀ = log(dur_saturated_immune)
        dur_immune_α₁ = (log(dur_mixed_immune) - log(dur_saturated_immune)) * (dur_immune_shape_1 + dur_immune_shape_2)^(dur_immune_shape_1 + dur_immune_shape_2) * dur_immune_shape_1^-dur_immune_shape_1 * dur_immune_shape_2^-dur_immune_shape_2
        dur_immune_t = exp.(dur_immune_α₀ .+ dur_immune_α₁ .* prop_variant_2_with_immunity_offset.^dur_immune_shape_1 .* (1 .- prop_variant_2_with_immunity_offset).^ dur_immune_shape_2)
    end
    ...
    elseif immunity_model == "seq-informed"
        gq = merge(gq, (
            ...
            dur_immune_shape_1=dur_immune_shape_1,
            dur_immune_shape_2=dur_immune_shape_2,
