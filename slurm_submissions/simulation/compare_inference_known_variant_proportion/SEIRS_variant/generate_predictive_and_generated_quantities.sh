...
julia --project --threads 1 scripts/simulation/compare_inference_known_variant_proportion/SEIRS_variant/generate_predictive_and_generated_quantities.jl $SLURM_ARRAY_TASK_ID