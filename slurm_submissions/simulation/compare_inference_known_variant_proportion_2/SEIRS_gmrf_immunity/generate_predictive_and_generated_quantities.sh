...
julia --project --threads 1 scripts/simulation/compare_inference_known_variant_proportion_2/SEIRS_GMRF_immunity/generate_predictive_and_generated_quantities.jl $SLURM_ARRAY_TASK_ID
