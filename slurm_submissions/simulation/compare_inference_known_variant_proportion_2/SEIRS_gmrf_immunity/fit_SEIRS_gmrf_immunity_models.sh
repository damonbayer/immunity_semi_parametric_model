...
julia --project --threads 4 scripts/simulation/compare_inference_known_variant_proportion_2/SEIRS_GMRF_immunity/fit_SEIRS_GMRF_immunity_model.jl $SLURM_ARRAY_TASK_ID
