...
julia --project scripts/simulation/sensitivity_analysis_cross_immunity_transmissibility/generate_predictive_and_generated_quantities_bin.jl $SLURM_ARRAY_TASK_ID
julia --project scripts/simulation/sensitivity_analysis_cross_immunity_transmissibility/generate_peak_quantities_bin.jl $SLURM_ARRAY_TASK_ID
