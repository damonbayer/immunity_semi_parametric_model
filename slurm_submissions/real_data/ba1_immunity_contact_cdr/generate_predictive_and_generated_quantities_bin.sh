...
julia --project scripts/real_data/ba1_immunity_contact_cdr/generate_predictive_and_generated_quantities_bin.jl $SLURM_ARRAY_TASK_ID
julia --project scripts/real_data/ba1_immunity_contact_cdr/generate_peak_quantities_bin.jl $SLURM_ARRAY_TASK_ID
